...
Shipwright pairs a **deterministic graph engine** ([acpx fork](https://github.com/aster2709/acpx)) with **Claude Code** as the agent runtime. The graph handles scheduling, retries, and branching. The LLM handles reasoning and coding.
